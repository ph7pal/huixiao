<div class="form mod">
    ...
    <p><label>用户：</label><input class="form-control" value="<?php echo tools::hideWord($info['username']); ?>" disabled/></p>    
    <p><label>邮箱：</label><input class="form-control" value="<?php echo tools::hideWord($info['email']); ?>" disabled/></p>
