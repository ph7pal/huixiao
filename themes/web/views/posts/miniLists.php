...
$colitems = Posts::allPosts(array('colid'=>$colinfo['id'],'condition'=>$colinfo['listcondition'],'top'=>zmf::config('orderByTop'),'fields'=>isset($fields) ? $fields : 'id,title,attachid,cTime','order'=>isset($order) ? $order : ''),$listNum,$uid); 
if($this->inMobile){
    $list_colnum=12;
}else{
