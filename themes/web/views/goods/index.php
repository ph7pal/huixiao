        <div class="w_960 content b_search big_mod clearfix">
            ...
            <div class="my_shop ">
                ...
                <div class="redNav yahei">
                    ...
                    <div class="right" style="left: 10px; width: 900px;">当前共有产品 <span class="bigFont">554</span> 款<a target="_blank" href="#" class="link">我要发布产品</a></div>
            ...
            <div class="ly_lt">
                ...
                <div class="b_pade">
                    ...
                    <span class='page_text'>1/7446</span><span class='page_span'><a><</a></span><span class='page_span cur'><a onfocus='this.blur()' href='#'>></a></span>
                </div>
                <!--列表选项 end-->
                <!--产品列表 start-->
                ...
                <div class="b_result">
                    ...
                    <div class="pageNavigation">
                        <div id="pagebar" class="pageNavigation">页次：<em class="c_page">1</em>/10 <span class="prev"><a class="nopage" href="#">上一页</a></span><a class="select">1</a><a href="#">2</a><a href="#">3</a><a href="#">4</a><a href="#">5</a><a href="#">6</a><span class="break">...</span><a href="#">9</a><a href="#">10</a><span class="next"><a class="" href="#">下一页</a></span></div>
                    </div>
                    <!--数据显示分页结束-->
                </div>
