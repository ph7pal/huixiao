...
class AjaxController extends T {
    ...
    public function actionComment() {
        ...
        if ($type == 'posts') {
            ...
            $postUrl = Yii::app()->createUrl('posts/index', array('id' => $keyid));
        } else {
                ...
                if ($model->save()) {
                    if ($info['uid'] != Yii::app()->user->id) {
                        ...
                        $params = array(
                          ...
                          'from_idtype' => $type,
                          'type' => 'notice',
                          'content' => '您有了新的评论，' . CHtml::link('查看详情', $postUrl)
                        );
        ...
        if (isset($_POST['Message'])) {
            ...
            if ($model->save()) {
                ...
                $params = array(
                  ...
                  'from_idtype' => 'goods',
                  'type' => 'notice',
                  'content' => '您有了新的留言，' . CHtml::link('查看详情', array('goods/view', 'id' => $keyid))
                );
                Notification::add($params);
