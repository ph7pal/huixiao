...
<p><label>杂志名称<span class="required">*</span>：</label><input class="form-control bitian" name="magazinename" id="magazinename" type="text" value="<?php echo $info['magazinename']; ?>" <?php echo $disabled;?>/></p>
