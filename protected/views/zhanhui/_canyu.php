...
<p><span class="sp_01">你的身份：</span><span><label for="cj" style=" font-size:14px; cursor:pointer; line-height:30px;">生产厂家</label> <input type="radio" name="<?php echo CHtml::activeName($model,'type');?>" id="cj" checked="checked" style="vertical-align:middle;" value="生产厂家"><label for="jxs" style=" font-size:14px; cursor:pointer;line-height:30px; margin-left:20px;">经销商</label> <input type="radio" name="<?php echo CHtml::activeName($model,'type');?>" id="jxs" style="vertical-align:middle;" value="经销商"><label for="qt" style=" font-size:14px; cursor:pointer;line-height:30px; margin-left:20px;">其他</label> <input type="radio" name="<?php echo CHtml::activeName($model,'type');?>" id="qt" style="vertical-align:middle;" value="其他"></span></p>
