...
class Magazine extends CActiveRecord {
  ...
  public function rules() {
    ...
    return array(
        array('uid, faceimg, localarea, companyname, companyowner, officurl, contactname, contactmobile, mainproduct, magazinename, licensenumber, cTime, hits, top, status, medal_logo, medal_title', 'required'),
