...
/**
 * This is the model class for table "{{credit_relation}}".
 *
 * The followings are the available columns in table '{{credit_relation}}':
 * @property string $id
 ...
 */
class CreditRelation extends CActiveRecord {

  /**
   * @return string the associated database table name
   */
  public function tableName() {
    return '{{credit_relation}}';
  }
   ...
   * @return CreditRelation the static model class
   */
