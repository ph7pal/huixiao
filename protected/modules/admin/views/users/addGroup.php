...
<table>	
  ...
  <div class="form-group">
    ...
    <?php echo $form->passwordField($model,'posts_perh',array('class'=>'form-control')); ?>
     <p class="help-block"><?php echo $form->error($model,'posts_perh'); ?></p>
  </div>
  <div class="form-group">
    <?php echo $form->labelEx($model,'comments_perh'); ?>
    <?php echo $form->passwordField($model,'comments_perh',array('class'=>'form-control')); ?>
     <p class="help-block"><?php echo $form->error($model,'comments_perh'); ?></p>
  </div>
  <div class="form-group">
    <?php echo $form->labelEx($model,'attach_perh'); ?>
    <?php echo $form->passwordField($model,'attach_perh',array('class'=>'form-control')); ?>
