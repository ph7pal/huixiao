...
<tr><td>待审核评论：<?php if($siteinfo['commentsNum']){ echo CHtml::link($siteinfo['commentsNum'],array('all/list','table'=>'posts','type'=>'staycheck'),array('class'=>'btn btn-xs btn-danger'));}else{echo $siteinfo['commentsNum'];}?></td></tr>
