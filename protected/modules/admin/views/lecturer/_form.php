...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		...
		<?php echo $form->textField($model,'belongCompany',array('size'=>60,'maxlength'=>255,'class'=>'form-control')); ?>
		<?php echo $form->error($model,'belongCompany'); ?>
	</div>

	<div class="form-group">
		<?php echo $form->labelEx($model,'belongTeam'); ?>
		<?php echo $form->textField($model,'belongTeam',array('size'=>60,'maxlength'=>255,'class'=>'form-control')); ?>
