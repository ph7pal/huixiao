...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('belongCompany')); ?>:</b>
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('medal')); ?>:</b>
	<?php echo CHtml::encode($data->medal); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('medal_logo')); ?>:</b>
	<?php echo CHtml::encode($data->medal_logo); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('medal_title')); ?>:</b>
	<?php echo CHtml::encode($data->medal_title); ?>
	<br />
