        ...
        init: function(d, e) {
            return this.each(function() {
                ...
                if (h) {
                    ...
                    var f = c("<div />", {
                        id: j.id + "-button",
                        "class": "uploadify-button btn btn-success" + j.buttonClass
                    });
                    if (j.buttonImage) {
                        f.css({
                    ...
                    f.html('<span class="glyphicon glyphicon-plus"></span> <span class="uploadify-button-text">' + j.buttonText + "</span>").css({
                        height: j.height + "px",
                        width: j.width + "px"
                    });
                    l.append(f);
                ...
                if (e[0]) {
                    if (e[0] == "*") {
                        ...
                        c("#" + j.queueID).find(".uploadify-queue-item").each(function() {
                            ...
                            c(this).find(".progress-bar").remove();
                        ...
                        for (var m = 0; m < e.length; m++) {
                            ...
                            c("#" + e[m]).find(".progress-bar").remove();
    ...
    var a = {
        ...
        onSelect: function(g) {
            ...
            if (c.inArray("onSelect", h.overrideEvents) < 0) {
                c("#" + h.queueID).append('<div id="' + g.id + '" class="uploadify-queue-item alert alert-success"><div class="close"><a href="javascript:$(\'#' + h.id + "').uploadify('cancel', '" + g.id + '\')"><span>&times;</span></a></div><span class="fileName">' + j + " (" + i + ')</span><span class="data"></span><div class="progress progress-striped active"><div class="progress-bar"><!--Progress Bar--></div></div></div>');
            }
        ...
        onUploadError: function(e, i, h) {
            ...
            if (c.inArray("onUploadError", f.overrideEvents) < 0) {
                ...
                c("#" + e.id).find(".progress-bar").css("width", "1px");
        ...
        onUploadProgress: function(g, m, j) {
            ...
            if (c.inArray("onUploadProgress", h.overrideEvents) < 0) {
                ...
                c("#" + g.id).find(".progress-bar").css("width", p + "%");
            }
